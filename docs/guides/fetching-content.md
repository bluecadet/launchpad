...
- **Monitor Progress**: Forward logs and lifecycle events to an aggregator with the [observability package](../reference/observability/index.md) to track content updates.
