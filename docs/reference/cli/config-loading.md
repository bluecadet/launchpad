...
- `content()` - Content management settings ([Content Config Reference](../content/content-config.md))
- `monitor()` - Process monitoring settings ([Monitor Config Reference](../monitor/monitor-config.md))

## Environment Variables

Config files can reference environment variables using the `process.env` object in JavaScript configs. For managing environment variables, see the [Environment Variables](./env.md) documentation.
