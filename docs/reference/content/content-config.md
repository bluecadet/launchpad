...
See [Versioning](./versioning.md) for configuration defaults, publishing, retention, mode-switch behavior, and status output. Applications that consume versioned content must follow the [Version Manifest](./version-manifest.md) contract.
