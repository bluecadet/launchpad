...
[github](https://github.com/bluecadet/launchpad/tree/main/packages/controller) ·
[npm](https://www.npmjs.com/package/@bluecadet/launchpad-controller) ·
[changelog](https://github.com/bluecadet/launchpad/blob/main/packages/controller/CHANGELOG.md)

The controller package is the orchestration layer every other subsystem plugs into. It owns the plugin lifecycle, routes commands, and carries the event bus that content, monitor, scheduler, and observability all communicate over.
