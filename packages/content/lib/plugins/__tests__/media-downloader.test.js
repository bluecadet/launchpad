...
describe('mediaDownloader', () => {
	...
	describe('localFilePathFromUrl', () => {
		it('should strip protocol and domain', () => {
			expect(localFilePathFromUrl('https://example.com/path/to/file.jpg'))
				.toBe(`path${path.sep}to${path.sep}file.jpg`);
		});

		it('should handle URLs without leading slash', () => {
			expect(localFilePathFromUrl('https://example.com/file.jpg'))
				.toBe('file.jpg');
		});

		it('should handle URLs with query params', () => {
			expect(localFilePathFromUrl('https://example.com/path/file.jpg?size=large'))
				.toBe(`path${path.sep}file.jpg?size=large`);
		});
	});
