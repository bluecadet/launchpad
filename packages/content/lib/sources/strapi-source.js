import qs from 'qs';
import { defineSource, SourceConfigError, SourceFetchError } from './source.js';
 ...
 * @returns {import('neverthrow').ResultAsync<string, SourceFetchError>} The JSON web token generated by Strapi
 */
