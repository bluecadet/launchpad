...
import { onExit, LogManager, type Logger } from "@bluecadet/launchpad-utils";
...
import { resolveMonitorConfig, type MonitorConfig, type ResolvedMonitorConfig } from "./monitor-config.js";
