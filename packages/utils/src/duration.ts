...
/**
 * Parses a duration shorthand string ("500ms" | "30s" | "5m" | "2h") or a raw
 * millisecond number into a millisecond count. Returns `null` for anything
 * unparseable, negative, or non-finite.
 */
...
/**
 * Zod schema that accepts a duration shorthand string or a raw millisecond
 * number and resolves to the parsed millisecond value.
 */
